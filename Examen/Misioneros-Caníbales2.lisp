...
(defun aptitud(estado)
	(+ (first (first estado)) (second (first estado)) (third (first estado))))
...
(defun buscar-estado-eval (estado nodos indice)
	(cond 
		((null nodos) (return-from buscar-estado-eval -1))
		((eql estado (second (first nodos))) (list indice (sixth (first nodos)) ))
	      ...
	      (cond
	      	...
	      	((eql metodo :a*) 
	      		(typecase busqueda
	      			...
	      			(T 
	      				(when (< (sixth nodo)  (first busqueda)) 
	      					(setf (nth (second busqueda) *open* ) nodo) ) )) )))
...
;;;=======================================================================================
;;;=======================================================================================
(blind-search  '((3 3 1) (0 0 0)) '((0 0 0) (3 3 1)) :a*)
(rest (loop for x in *solucion* 
	collect (loop for y in *ops* do (when (eql (first y) (fourth x)) (return (second y))  ))))